<template>
    <Modal @close="modals.close(id)">
        ...
        <div class="flex flex-col my-2">
            ...
            <div>
                <MdcSwitch
                    v-model="columnsToShow.nextDate"
                    class="ml-3"
                    id="nextDate"
                >
                    Next date
            ...
            <div>
                <MdcSwitch
                    v-model="columnsToShow.nextAmount"
                    class="ml-3"
                    id="nextAmount"
                >
                    Next amount
            ...
            <div>
                <MdcSwitch
                    v-model="columnsToShow.overMinimum"
                    class="ml-3"
                    id="overMinimum"
                >
                    Over/under min.
            ...
            <div>
                <MdcSwitch
                    v-model="columnsToShow.percentCovered"
                    class="ml-3"
                    id="percentCovered"
                >
                    % covered
        ...
        <div class="flex flex-col my-2">
            <MdcSwitch
                v-model="homeSettings.historyButtons"
                class="ml-3"
                id="history-buttons"
            >
