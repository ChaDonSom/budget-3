        ...
        <div class="text-center m-3">
            <div v-if="initiallyLoaded" class="mb-5">
                ...
                >
                    <template #header>
                        ...
                        <DataTableHeaderCell> Ideal </DataTableHeaderCell>
                    ...
                    <template #body>
                        <DataTableRow v-for="account of sortedAccounts">
                            <DataTableCell @click="editAccount(account.id)">
                            ...
                            <DataTableCell>
                                <div
                                    ...
                                    v-tooltip="
                                        `Emergency ${emergencySaving(
                                            account
                                        )} / week over ${paydaysUntil(
                                            toDateTime(
            ...
            <Teleport to="body">
                <div v-if="initiallyLoaded">
                    ...
                    />
                    <IconButton
                        v-if="initiallyLoaded && areAnyBatchDifferences"
            ...
            <transition name="error-message">
                <p
                    ...
                    class="bg-red-200 rounded-3xl py-3 px-4 mb-2 break-word max-w-fit"
                >
...
async function loadTemplate() {
    if (route.params.id && route.params.id != "new") {
        const result = (await templates.fetchTemplate(
        ...
        try {
            await modals.confirm(
                `Do you really want to delete ${
                    templates.data[Number(route.params.id)].name
                }?`
            )
        } catch (e) {
            return
