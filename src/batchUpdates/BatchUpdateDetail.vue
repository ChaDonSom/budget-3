    ...
    <div class="max-h-screen mx-3">
                ...
                <tbody>
                    <tr v-for="account_id of Object.keys(batchDifferences)">
                        ...
                        <td class="pl-3 text-right">
                            {{
                                dollars(
                                    batchDifferences[Number(account_id)]
                                        .resolved
                                )
                            }}
                        </td>
        ...
        <transition name="opacity-0-scale-097-150ms" mode="out-in">
            ...
            >
                ...
                <Button
                    @click="
                        batchForm.weeks = batchForm.weeks == null ? 4 : null
                    "
                >
                    {{
        ...
        <transition name="error-message">
            <p
                ...
                class="bg-red-200 rounded-3xl py-3 px-4 mb-10 break-word max-w-fit text-red-700"
            >
