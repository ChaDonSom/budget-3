<template>
  <div class="flex flex-col items-center relative">
    ...
    <Button @click="auth.login(form)" raised :disabled="form.processing" class="mt-5">Log in</Button>
    <RouterLink to="register"><Button class="mt-2">Don't have an account?</Button></RouterLink>
